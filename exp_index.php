...
if($page->have_any_perm(array(PERM_ADMIN,PERM_ADMIN_ISTAC)))
{
	$viewvars['url_encuesta'] = $page->build_url(PAGE_EXP_FORMULARIO,
			array(ARG_TRIM	=>	$exp_estado['trimestre']->trimestre,
					ARG_ANO	=>	$exp_estado['trimestre']->anyo,
...
/// Render de la pagina
$page->render( "exp_index_view.php", $viewvars );
