...
$nombre_fichero="empleo_istac_".$establecimiento->id_establecimiento."_".$ano_encuesta."_".$mes_encuesta.".pdf";
...
$pdf->WriteHTML("<br><br><br><br><br><b><u><i>Módulo de Empleo de la Encuesta de Alojamiento Turístico</i></u></b>");
