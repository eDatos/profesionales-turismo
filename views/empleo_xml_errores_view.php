...
<div id="bloq_interior">
	...
	<div class="bloq_central">
		...
		<div class="cuadro fondo_verde" style="text-align: justify;" class="noprint">
			...
			<p>Sus datos de empleo han sido subidos y procesados con éxito.</p>
			<?php if (isset($email)) : ?>
		...
		<div style="padding-top: 6px;float: left;"><a href="<?= urlVolver;?>"><img src="images/volver.png" border="0" class="noprint"></a> <a href="<?= $urlVolver;?>" class="enlace noprint" style=" position: relative; top: -2px;">Volver a la encuesta</a></div>
