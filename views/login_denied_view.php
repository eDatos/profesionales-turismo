...
<div id="bloq_interior">
    ...
    <div class="bloq_central"> 
    	<div class="cuadro" style="width: 50%; margin-left:25%; margin-top:10%; border: 1px solid #dddddd;background-color:#FFF2E8;">
            <h2 class="titulo_2" style="float:left;">Acceso denegado</h2>
            <a href="#" class="ayudaicon enlace" style="float:right;margin-top:4px;" title="Ayuda (tecla de acceso: y)" accesskey="y"><strong>Ayuda</strong></a>
            <div class="subrayado"></div>
            <p>El acceso le ha sido denegado debido a que el establecimiento consta como cerrado.</p>          
        </div>    	
    </div>
