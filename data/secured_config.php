...
define("PERMS_ANY", PERM_USER.",".PERM_GRABADOR.",".PERM_RECEPCION.",".PERM_ADMIN_ISTAC.",".PERM_ADMIN );
...
$_CONFIGPWET['conf_seguridad'] = array(
		...
		OP_VIEW_ESTAB_DATA		  => array(PERM_ADMIN, PERM_ADMIN_ISTAC, 			    PERM_USER, PERM_RECEPCION),
		OP_CHANGE_PASSWORD	  	  => array(PERM_ADMIN, PERM_ADMIN_ISTAC, 			    PERM_USER, PERM_RECEPCION)
);
